...
let make = (~questionId: int, ~nom: string, ~setNom: (string => string) => unit) => {
  ...
  if !isStarted {
    ...
    <div className="max-w-md mx-auto mt-24 p-8 rounded-2xl text-center" style={{background: "rgba(255,255,255,0.10)", backdropFilter: "blur(16px)", border: "1px solid rgba(255,255,255,0.20)"}}>
      ...
      <input
        className="w-full px-4 py-2 rounded-lg mb-5 text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-violet-400" style={{background: "rgba(255,255,255,0.12)", border: "1px solid rgba(255,255,255,0.25)"}}
        type_="text"
    ...
    <div className="max-w-md mx-auto mt-24 p-8 rounded-2xl" style={{background: "rgba(255,255,255,0.10)", backdropFilter: "blur(16px)", border: "1px solid rgba(255,255,255,0.20)"}}>
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <p className="text-sm text-white/60 font-semibold">
          {("Question " ++ questionNumber->Int.toString ++ " / " ++ totalQuestions->Int.toString)->React.string}
        </p>
      </div>
      // ── Barre de progression ──
      <div className="w-full rounded-full mb-6" style={{background: "rgba(255,255,255,0.15)", height: "6px"}}>
        <div
      ...
      <div className="flex flex-col gap-3">
        ...
        ->Array.map(item =>
            ...
            <button
              ...
              className="px-4 py-3 text-left text-white font-medium rounded-lg transition-all border border-white/20 hover:border-violet-400 shadow-sm hover:scale-[1.02]" style={{background: "rgba(255,255,255,0.08)"}}
            >
